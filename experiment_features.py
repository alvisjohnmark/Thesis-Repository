...
# file = '/audio_features_25_soxrHQ_44_dominant_all_stacked_169.csv'
df = pd.read_csv(file)
df.head()
...
df2 = pd.read_csv("/dataset/music_genres.csv")
...
path = '/dataset/music_genres_result_svm.csv'
...
df3 = pd.read_csv("/dataset/APT_segments.csv")
...
path = '/dataset/recognized_APT_segments.csv'
with open(path, 'w', encoding = 'utf-8-sig') as f:
  X_best.to_csv(f)
